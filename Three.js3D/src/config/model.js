...
const modelList = [
	...
	},
	{
		...
		id: 27,
		animation: false,
		filePath: 'threeFile/glb/glb-32.glb',
	...
	},
	{
		...
		id: 28,
		animation: false,
		filePath: 'threeFile/glb/glb-35.glb',
	...
	},
	{
		...
		id: 29,
		animation: false,
		filePath: 'threeFile/glb/glb-37.glb',
		icon: require('@/assets/model-icon/22.png')
	},
	{
		name: '罗汉',
		key: 'woodcarving(1)',
		...
		id: 30,
		animation: false,
		filePath: 'threeFile/glb/glb-38.glb',
		icon: require('@/assets/model-icon/23.png')
	},
	{
		name: '木雕花瓶',
		key: 'woodcarving(2)',
		...
		icon: require('@/assets/model-icon/24.png')
	},
	{
		name: '竹簧梳妆盒',
		key: 'Dressing case',
		...
		icon: require('@/assets/model-icon/25.png')
	},
]
